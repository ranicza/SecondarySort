...
public class CompKeyPartitioner extends Partitioner<CompositeKey, NullWritable>{
	...
	/*
	 * It's doesn't need to carry any information in the value, because we can get the
	 * first (maximum) timestamp in the Reducer from the key, so it's used a NullWritable.
	 * 
	 */
	@Override
